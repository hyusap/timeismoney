...
function CCTVPlaceholder({ index }: { index: number }) {
  return (
    <div className="relative w-full h-full bg-gray-900 border-2 border-gray-800 flex items-center justify-center overflow-hidden">
      {/* Scan line effect */}
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-gray-800/20 to-transparent animate-pulse"></div>

      {/* Camera icon and text */}
      <div className="relative z-10 flex flex-col items-center justify-center opacity-30">
        <svg
          className="w-16 h-16 text-gray-700 mb-2"
          fill="currentColor"
          viewBox="0 0 20 20"
        >
          <path d="M2 6a2 2 0 012-2h6a2 2 0 012 2v8a2 2 0 01-2 2H4a2 2 0 01-2-2V6zm12.553 1.106A1 1 0 0014 8v4a1 1 0 00.553.894l2 1A1 1 0 0018 13V7a1 1 0 00-1.447-.894l-2 1z" />
        </svg>
        <div className="text-gray-700 font-mono text-xs">CAM {index + 1}</div>
        <div className="text-gray-800 font-mono text-xs mt-1">OFFLINE</div>
      </div>

      {/* Corner timestamp */}
      <div className="absolute top-2 left-2 text-gray-700 font-mono text-xs">
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black flex flex-col">
      ...
      <div className="bg-gray-950 border-b border-gray-800 px-4 py-2 flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div className="text-gray-500 font-mono text-xs">
            {isLoading ? "LOADING..." : `${activeRooms.length} / ${TOTAL_GRID_SLOTS} ACTIVE`}
          </div>
      ...
      <div className="flex-1 grid grid-cols-4 grid-rows-3 gap-1 p-1 bg-black">
        ...
        {gridItems.map((room) => (
          <Link
            ...
            className="relative w-full h-full bg-gray-900 border-2 border-gray-800 hover:border-red-500 transition-all overflow-hidden group"
          >
            <StreamPreview
              roomName={room.name}
      ...
      <div className="bg-gray-950 border-t border-gray-800 px-4 py-2 flex items-center justify-center space-x-3">
        <Link
          href="/stream"
        ...
        <Link
          href="/auctions"
          className="bg-gray-800 hover:bg-gray-700 text-white px-4 py-1.5 text-xs font-mono font-bold transition"
        >
          TIME AUCTIONS
        </Link>
      </div>
